...
import co.edu.unal.colswe.changescribe.core.ui.DescribeVersionsDialogUtil;
import co.edu.unal.colswe.changescribe.core.ui.FilteredCheckboxTree;
...
public class GenerateMessagePage extends WizardPage implements IDialog {
	...
	public GenerateMessagePage(Shell shell, HashSet<Object> hashSet, Git git, IJavaProject selection) {
	...
	private Section createFileSection(Composite container) {
		...
		FilteredCheckboxTree resourcesTreeComposite = new FilteredCheckboxTree(filesArea, toolkit, SWT.BORDER, patternFilter);
		...
		resourcesTreeComposite.setLayoutData(GridDataFactory.fillDefaults().hint(600, 100).grab(true, true).create());
		resourcesTree.setSize(600, 50);
